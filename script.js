...
const ti108 = '<h4 class="text" style="font-size: 2rem; opacity: 0; transition: 0.3s;">TI-108 Elementary Calculator</h4>' +
    ...
    'Every story has their beginnning, and for many of us, this calculator is the start of our journey into math.' +
    '<br></p>' +
    '<p class="text" style="opacity: 0; transition: 0.3s; padding-top: 1rem; text-indent: 2rem; font-size: 20px;">' +
    ...
    'ten and are distributed in a yellow carrying case. Looking back into my childhood rememories, I specifically remember the blue rectangular ' +
    ...
    'calculator using the keywords \"calcualtor\", \"blue\", \"reactangle\", and \"elementary\". Suffice to say, this calculator ' +
    'brings back memories of a simpler childhood, a simpler life, and a simpler level of math to learn.' +
    '<br></p>' +
    '<p class="text" style="opacity: 0; transition: 0.3s; padding-top: 1rem; text-indent: 2rem; font-size: 20px;">' +
    'The operaters are very simple: addition, subtraction, multiplication, and division. It can also manage percentages and square roots. ' +
...
const ti30xiis = '<h4 class="text" style="font-size: 2rem; opacity: 0; transition: 0.3s;">TI-30X<i>IIS</i> Scientific Calculator</h4>' +
    ...
    'a classification of calculators that can perform algebriac, trigometric, and geometric functions.' +
    '<br></p>' +
    '<p class="text" style="opacity: 0; transition: 0.3s; padding-top: 1rem; text-indent: 2rem; font-size: 20px;">' +
    ...
    'to respect the order of operations. Scientific calculators are simply more complex than their basic calculator bretheren.' +
    '<br></p>' +
    '<p class="text" style="opacity: 0; transition: 0.3s; padding-top: 1rem; text-indent: 2rem; font-size: 20px;">' +
    'The TI-<b>30X</b><i>IIS</i> is what got me through algebra and basic trigonometry. I remember the heavy use of SIN, COS, and TAN ' +
    'in particular to solve triangular angles and side measurements. While I also appreciated the ability to wrap math functions in ' +
    'parentheses, ( and ), they simply were not utilized for the math work I was doing. I also remember a using π alot, so seeing this ' +
...
const ti36XPro = '<h4 class="text" style="font-size: 2rem; opacity: 0; transition: 0.3s;">TI-36X Pro</h4>' +
    ...
    '<br></p>' +
    '<p class="text" style="opacity: 0; transition: 0.3s; padding-top: 1rem; text-indent: 2rem; font-size: 20px;">' +
    'This is one of the most advanced scientific calculators you can get before advancing into the graphing calculators, becuase the display ' +
    'is no longer using a seven-segment display to show numbers. This is dot-matrix display, a whole different level of displaying numbers ' +
    ...
    '<br></p>' +
    '<p class="text" style="opacity: 0; transition: 0.3s; padding-top: 1rem; text-indent: 2rem; font-size: 20px;">' +
    'The reason my high school required this calculator, is to prevent cheating on tests. There is not a way of storing letters or connecting ' +
...
const ti83Plus = '<h4 class="text" style="font-size: 2rem; opacity: 0; transition: 0.3s;">TI-83 Plus Graphing Calculator</h4>' +
    '<p class="text" style="opacity: 0; transition: 0.3s; padding-top: 1rem; text-indent: 2rem; font-size: 20px;">' +
    'This calculator is what I imagine most people my age remember. Perhaps it is something that you remember seeing as well, and being forced to use ' +
    ...
    'that was our only way of communicating back then. This kind of tech was astonishing for its time; that I could write a SIN function, ' +
    ...
    'permitted in the classroom when the professor gave us instruction to do so. If your graphing calculator was on your desk before ' +
    'the professor permitted, then they would take it from you.</p>'
...
const ti84PlusCE = '<h4 class="text" style="font-size: 2rem; opacity: 0; transition: 0.3s;">TI-84 Plus Color Edition Graphing Calculator</h4>' +
    '<p class="text" style="opacity: 0; transition: 0.3s; padding-top: 1rem; text-indent: 2rem; font-size: 20px;">' +
    'The 84 series of graphing calculators have been one of the most intersting line of technology to follow. The 84 series has quite a large ' +
    'number of different kinds of calculators, which the color editon is the one that I picked, missing out on the former TI-84 Plus.' +
    '<br></p>' +
    '<p class="text" style="opacity: 0; transition: 0.3s; padding-top: 1rem; text-indent: 2rem; font-size: 20px;">' +
    ...
    'black, blue, white, gray, purple, coral, mint, red, rose gold and teal. The one that I got is the gray, as I rather like the shade much ' +
    ...
    'appear as a solid, dash, or dotted lines to differentiate. Shading would also be done by making a series of horizontal lines and ' +
    ...
    'when I started to become obsessed with math and numbers. In particular, writing and solving math problems in a new way of thinking.</p>'
...
const hpPrime = '<h4 class="text" style="font-size: 2rem; opacity: 0; transition: 0.3s;">HP Prime Graphing Calculator</h4>' +
    ...
    'Solving basic math problems is nice and easy, but when graphing is needed, there are options. HP includes a number of graphing ' +
    ...
    'touch screen. The setting menu also provides different ways to display the time, allows for color customization in the screen, and also, ' +
    ...
    'be entered using Reverse Polish Notation, and Algebriac styling.</p>'
...
const hp15c = '<h4 class="text" style="font-size: 2rem; opacity: 0; transition: 0.3s">HP 15C Limited Edition ' +
    ...
    '<p class="text" style="opacity: 0; transition: 0.3s; padding-top: 1rem; text-indent: 2rem; font-size: 20px;">' +
    'Sometimes, when you are at home, you just get the feeling to solve some difficult math problems. This is where my 15C comes in. ' +
    ...
    'solving, and wanted to use an old-fassioned calculator that is made to use RPN. Of the 10C series of calculators, the only one ' +
...
const hp35s = '<h4 class="text" style="font-size: 2rem; opacity: 0; transition: 0.3s;">HP 35s Programmable Scientific Calculator</h4>' +
    ...
    'an RPN calculator first. While there is a way to activate infix notation, I would not recommend using it due to the very aparant display ' +
    'issues that happen. The 35s is vertically minded to see the current numbers in a call stack, where infix is horizontally minded.' +
    '<br></p>' +
    '<p class="text" style="opacity: 0; transition: 0.3s; padding-top: 1rem; text-indent: 2rem; font-size: 20px;">' +
    'This is one of the preferred calculator to use for engineering tests. This is because unlike graphing calculators, there is no memory to store ' +
    ...
    'test, functions can be programmed into the calculator during the test and used repeatidly to solve problems. Like the 15C, functions can ' +
...
const tiNSpire = '<h4 class="text" style="font-size: 2rem; opacity: 0; transition: 0.3s">TI-n<b>spire</b> CX II Graphing Calculator</h4>' +
    '<p class="text" style="opacity: 0; transition: 0.3s; padding-top: 1rem; text-indent: 2rem; font-size: 20px;">' +
    'This calculator is something different. I got it to satisfy a curiosity, to see if the TI-n<b>spire</b> CX II would be the ' +
    ...
    '<br></p>' +
    '<p class="text" style="opacity: 0; transition: 0.3s; padding-top: 1rem; text-indent: 2rem; font-size: 20px;">' +
    'Problems immeidately show up right when powering on. The calculator does not open a screen which math problems can be solved. ' +
    ...
    '<br></p>' +
    '<p class="text" style="opacity: 0; transition: 0.3s; padding-top: 1rem; text-indent: 2rem; font-size: 20px;">' +
    'The structure of the common calculator document is listed as problems, that have multiple pages to define the problem and show graphs. ' +
